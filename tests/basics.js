...
test('basics', (t) => {
    ...
    // Make sure it is not an abstract base class (regression check)
    const cl = new Ammo.ClosestRayResultCallback(vec, vec);
    let found = false;
...

    {
        ...
        // make sure we have the 2-param version of this
        const constraint = new Ammo.btPoint2PointConstraint(body, new Ammo.btVector3(0, 0, 0));
        t.true(constraint !== undefined);
    }
