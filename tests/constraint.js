...
test('constraint', (t) => {
    function testConstraint() {
        ...
        // body 1
        const shape1 = new Ammo.btCapsuleShape((0.15), (0.20));
        ...
        const rbInfo1 = new Ammo.btRigidBodyConstructionInfo(mass1, myMotionState1, shape1, localInertia1);
        ...
        startTransform2.setOrigin(new Ammo.btVector3(-0.18, 0.65, 0.0));

        const myMotionState2 = new Ammo.btDefaultMotionState(startTransform2);
        const rbInfo2 = new Ammo.btRigidBodyConstructionInfo(mass2, myMotionState2, shape2, localInertia2);
        ...
        localA.getBasis().setEulerZYX(0, 0, -Math.PI / 4); localA.setOrigin(new Ammo.btVector3((-0.18), (-0.10), (0.0)));
        localB.getBasis().setEulerZYX(0, 0, -Math.PI / 4); localB.setOrigin(new Ammo.btVector3((0.0), (0.22), (0.0)));
